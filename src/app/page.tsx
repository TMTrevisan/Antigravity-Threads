  ...
  return (
    <AuthGate>
      <div className="flex-1 flex flex-col bg-[var(--bg-main)] text-[var(--text-primary)] min-h-screen">
        <main className="flex-1 flex flex-col lg:flex-row w-full mx-auto p-4 sm:p-6 gap-6 mb-24 lg:mb-0 max-w-7xl">
        <aside className="hidden lg:block w-56 shrink-0 space-y-2">
          ...
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.66-.9l.82-1.2A2 2 0 0110.07 4h3.86a2 2 0 011.66.9l.82 1.2a2 2 0 001.66.9H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            Snap
          </button>
        ...
        <section className="flex-1 min-w-0 space-y-6">
          ...
          {activeTab === 'snap' && (
            <SnapTab
              items={items}
              wearLogs={wearLogs}
              onSelectForValidation={setValidationTarget}
              notify={notify}
